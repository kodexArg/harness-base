...
**May Agent:** `hb-ag-owl` (The Owl) for vendor docs; otherwise infra fan-out only. Prefer the parent. Do not call The Dwarf, The Elf, or The Cleric to "fix" app code.
